...
using var server = new CriticalSocket(512);
using var client = new CriticalSocket(512);
...
client.Connect(new IPEndPoint(IPAddress.Parse("127.0.0.1"), 5000), 1000, (result) =>
{
